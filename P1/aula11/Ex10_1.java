...
public class Ex_10_1{
    ...
    public static void main(String []args)throws IOException{
        ...
        do{
            ...
            System.out.print("\n9 - Gravar a sequencia atual de numero num ficheiro");
            System.out.print("\n10 - Ordenar a sequencia por ordem crescente utilizando ordenacao sequencial");
            System.out.print("\n11 - Ordenar a sequencia por ordem decrescente utilizando ordenacao por flutuaçao");
            ...
            if(esc == 1){
               ...
               System.out.print("\n");
                ...
                seqOrder(a, a.length);
                 System.out.print("\nSequencia ordenada por ordenacao sequencial\n");
                 ...
                 floatOrder(a, a.length);
                 System.out.print("\nSequencia ordenada por ordenacao por flutuacao\n");
                 for(int i = 0; i < a.length; i++){
                    if(a[i] != 0){
                        System.out.println(a[i]);
                    }
        ...
        }while(esc != 1 || esc != 2 || esc != 3 || esc != 4 || esc != 5 || esc != 6 || esc != 7 || esc != 8 || esc != 9 || esc != 10 || esc != 11 || esc != 12 || esc != 13);
    ...
    public static void seqOrder(int[] z, int n){
        int tmp, i, j;
        for(i = 0; i < n-1; i++){
            for(j = i+1; j < n; j++){
                if(z[i] > z[j]){
    ...
    public static void floatOrder(int[] z, int n){
        int tmp, i;
        int nlo = 0;
        boolean trocas;
        do{
