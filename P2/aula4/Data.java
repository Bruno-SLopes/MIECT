...
public class Data {
  ...
  public Data(int dia, int mes, int ano) {
    assert (dia > 0 && dia <= diasDoMes(mes, ano) && mes > 0 && mes <= 12 && ano >= 0):"O dia ou o mes ou o ano nao cumprem com as condicoes";
    this.dia = dia;
    this.mes = mes;
    this.ano = ano;
  ...
  public static int diasDoMes(int mes, int ano) {
    assert (mes > 0 && mes <= 12 && ano >= 0) : "O ano ou o mes nao cumprem com as condicoes";
    int number_of_days;
    if(bissexto(ano)){
